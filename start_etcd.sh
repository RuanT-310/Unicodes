...
if [ "$NODE_NAME" == "mx-nodel" ]; then
    NODE_IP="172.21.0.10"
elif [ "$NODE_NAME" == "mx-node2" ]; then
    NODE_IP="172.21.0.11"
elif [ "$NODE_NAME" == "mx-node3" ]; then
    NODE_IP="172.21.0.12"
else
...
/usr/local/bin/etcd \
  ...
  --initial-cluster "mx-nodel=http://172.21.0.10:2380,mx-node2=http://172.21.0.11:2380,mx-node3=http://172.21.0.12:2380" \
