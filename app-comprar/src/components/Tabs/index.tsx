...
import { CircleDashedIcon, CircleCheckIcon } from "lucide-react-native"
    ...
    <View style={styles.container}>
      <View style={styles.tabs}>
        <TouchableOpacity onPress={() => onSelectFilter('pending')} style={styles.tabButton}>
          <CircleDashedIcon size={15} color={filter === 'pending' ? styles.tabTextActive.color : styles.tabText.color}/>
        ...
        <TouchableOpacity onPress={() => onSelectFilter('completed')} style={styles.tabButton}>
          <CircleCheckIcon size={15} color={filter === 'completed' ? "#2C46B1" : styles.tabText.color}/>
